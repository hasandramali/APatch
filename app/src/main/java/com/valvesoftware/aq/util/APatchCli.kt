...
import com.valvesoftware.aq.APApplication.Companion.SUPERCMD
import com.valvesoftware.aq.BuildConfig
import com.valvesoftware.aq.apApp
import com.valvesoftware.aq.ui.screen.MODULE_TYPE
import java.io.File
...
fun listModules(): String {
    ...
    withNewRootShell{
       newJob().add("cp /data/user/*/com.valvesoftware.aq/patch/ori.img /data/adb/ap/ && rm /data/user/*/com.valvesoftware.aq/patch/ori.img")
